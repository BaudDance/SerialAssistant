...
<template>
  <input id="setting-modal" type="checkbox" class="modal-toggle">
  <label for="setting-modal" class="modal cursor-pointer">
    <label class="modal-box relative" for="">
      ...
      <div class="flex items-center gap-x-5">
        ...
        <select v-model="lineEndingMode" class="select select-bordered w-full max-w-xs">
      ...
      <div v-if="lineEndingMode == undefined" class="h-3" />
      <div v-if="lineEndingMode == undefined" class="flex items-center gap-x-5">
        <span class="text-white w-60">自定义行尾:</span>
        <input v-model="lineSelfEnding" type="text" class="input input-bordered w-full max-w-xs">
      </div>
      <div class="h-3" />
      <div class="flex items-center gap-x-5">
        <span class="text-white w-60">中文编码:</span>
        <select v-model="dataCode" class="select select-bordered w-full max-w-xs">
